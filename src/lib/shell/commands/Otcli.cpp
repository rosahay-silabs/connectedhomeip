...
static CHIP_ERROR cmd_otcli_help_iterator(shell_command_t * command, void * arg)
{
    streamer_printf(streamer_get(), "  %-15s %s\n\r", command->cmd_name, command->cmd_help);
    return CHIP_NO_ERROR;
}

static CHIP_ERROR cmd_otcli_help(int argc, char ** argv)
{
...
static CHIP_ERROR cmd_otcli_dispatch(int argc, char ** argv)
{
